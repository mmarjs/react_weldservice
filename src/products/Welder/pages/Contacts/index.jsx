...
const Contacts = (props) => {
    ...
    return (
        <div className="page-wrapper">
            <Helmet>
                <title>{leadInfo.company_name} | Contact Us</title>
                <meta name="description" content={`Contact ${leadInfo.company_name}`} />
            </Helmet>
            <div style={setStyle}>
                <MainNav/>
                <div className="container">
                            ...
                            <Fade>
                                ...
                                <div className="">
                                    ...
                                    <div className="button-white">
                                        <a href={`tel:${leadInfo.phone_number}`}>Call Now</a>
                                    </div>
                                </div>
                            </Fade>
                        </div>
                    ...
                    <Fade bottom>
                        <p className="text-center privacy-paragraph">
                            <small>
                                Your Data is always safe with us. We will only contact you in conjunction with your
                                inquiry and your details are stored securely in the meantime.
                            </small>
                        </p>
                    </Fade>
                    <Fade bottom>
